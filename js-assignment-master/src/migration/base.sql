...
insert ignore into mydb.news (title, description, matchId, tourId, sportId) values ('Match 1 News', 'Match 1 description', 1, 1, 1);
insert ignore into mydb.news (title, description, matchId, tourId, sportId) values ('Match 2 News', 'Match 2 description', 2, 1, 1);
insert ignore into mydb.news (title, description, matchId, tourId, sportId) values ('Match 3 News', 'Match 3 description', 5, 2, 2);
insert ignore into mydb.news (title, description, matchId, tourId, sportId) values ('Match 4 News', 'Match 4 description', null, 3, 1);
insert ignore into mydb.news (title, description, matchId, tourId, sportId) values ('Match 5 News', 'Match 5 description', null, 4, 1);